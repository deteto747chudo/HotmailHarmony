...
╚═╝     ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝   ╚═╝          ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝"""
    ...
    print(fade.purpleblue("Proxy Tool | deteto_chudo"))
    print("Select an option to continue:")
    print(fade.purpleblue(" [1] Proxy Scraper\n [2] Proxy Checker\n [3] View Logs\n [4] Save Logs to output Folder\n [99] Exit to main menu"))
    user_input = input("Your Choice : ")

    if user_input == "1":
        call(["python", "./engine/ProxyToolEngine/run_proxy_scraper.py"])
    elif user_input == "2":
        call(["python", "./engine/ProxyToolEngine/run_proxy_checker.py"])
    elif user_input == "3":
        call(["python", "./engine/ProxyToolEngine/retrieve_proxy_output.py"])
    elif user_input == "4":
        call(["python", "./engine/ProxyToolEngine/save_proxy_output.py"])
    elif user_input == "99":
        call(["python", "./main.py"])
    else:
        gotostart()
