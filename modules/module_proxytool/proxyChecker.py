...
╚██████╗██║  ██║███████╗╚██████╗██║  ██╗██║██║ ╚████║╚██████╔╝██╗██╗██╗
 ╚═════╝╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝╚═╝╚═╝"""
    ...
    print(fade.purplepink(f"Checking {len(proxies)} proxies"))
    print(fade.purplepink("Please wait..."))
    ...
    print(fade.purplepink(f"Found {len(valid_proxies)} valid proxies, saved in output.txt"))
...
def main():
    ...
    base_dir = os.path.dirname(__file__)
    file_path = os.path.abspath(os.path.join(base_dir, '..', '..', 'output.txt'))
    parser.add_argument("-p", "--proxy", help="Check HTTPS, HTTP, SOCKS4, or SOCKS5 proxies", default="http")
    parser.add_argument("-l", "--list", help="Path to your proxy list file", default=file_path)
    parser.add_argument(
        "-s",
        "--site",
